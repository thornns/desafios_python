...
Se tivermos um estoque abaixo do estoque permitido para aquela categoria do produto, o time deve ser avisado (print)
para fazer um novo pedido daquele produto.
...
categoria_produto = input("Categoria do produto (alimentos, bebida ou limpeza): ")
quantidade_atual = input("Quantidade em estoque: ")

if nome_produto and categoria_produto and quantidade_atual:
    if categoria_produto == "alimentos" and int(quantidade_atual) < 50:
        print("Solicitar {} à equipe de compras, possuímos {} em estoque".format(nome_produto, quantidade_atual))
    if categoria_produto == "bebida" and int(quantidade_atual) < 75:
        print("Solicitar {} à equipe de compras, possuímos {} em estoque".format(nome_produto, quantidade_atual))
    if categoria_produto == "limpeza" and int(quantidade_atual) < 30:
        print("Solicitar {} à equipe de compras, possuímos {} em estoque".format(nome_produto, quantidade_atual))
else:
    print("Preencher todos os campos corretamente")
