...
saber todos os produtos que temos na empresa. Repare que a function pode receber 1, 2, 3 ou quantas
listas de estoque forem necessárias.
...
def lista_produtos(*produtos):
    ...
    for i in range(len(produtos)):
        for j in range(len(produtos[i])):
            lista_aux.append(produtos[i][j][0])
    return list(set(lista_aux))
...
teste = lista_produtos(estoque_fim_jan, estoque_fim_fev, estoque_fim_mar, estoque_fim_abr)
print(teste)
print(len(teste))
